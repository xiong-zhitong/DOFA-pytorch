...
class PanopticonClassification(LightningTask):
...
class PanopticonSegmentation(LightningTask):
    def __init__(self, args, config, data_config):
        super().__init__(args, config, data_config)
...
def PanopticonModel(args, config, data_config):
    if args.task == "classification":
        return PanopticonClassification(args, config, data_config)
    elif args.task == "segmentation":
        return PanopticonSegmentation(args, config, data_config)
    else:
