...
def get_args_parser():
    parser = argparse.ArgumentParser(
        "SatMAE++ fine-tuning for image classification", add_help=False
    )
    parser.add_argument(
        "--batch_size",
        default=8,
    ...
    parser.add_argument(
        "--patch_size", default=8, type=int, help="patch embedding patch size"
    )
    parser.add_argument(
        "--drop_path",
        type=float,
    ...
    parser.add_argument(
        "--finetune",
        default="./output_dir/checkpoint-50.pth",
    ...
    parser.add_argument(
        "--base_path",
        default="dataset/eurosat/2750/",
        type=str,
        help="dataset folder path",
    )  # for euorsat dataset
    parser.add_argument(
        "--train_path",
        default="dataset/fmow_sentinel/train.csv",
        type=str,
        help="Train .csv path",
    )
    parser.add_argument(
        "--test_path",
        default="dataset/fmow_sentinel/val.csv",
        type=str,
        help="Test .csv path",
    )
    parser.add_argument(
        "--dataset_type",
        default="sentinel",
        choices=["rgb", "sentinel", "euro_sat", "resisc", "ucmerced"],
    ...
    )  # 62 classes for fmow (rgb or sentinel)
    parser.add_argument(
        "--output_dir",
    ...
    parser.add_argument(
        "--log_dir", default="./finetune_logs", help="path where to tensorboard log"
    )
    parser.add_argument(
