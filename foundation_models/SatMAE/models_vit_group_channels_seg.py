...
class GroupChannelsVisionTransformer(VisionTransformer):
    ...
    """
    def __init__(self, out_indices, global_pool=False, channel_embed=256,
    ...
    def forward_features(self, x):
        ...
        for i,blk in enumerate(self.blocks):
            ...
            if i in self.out_indices:
                ...
                out = out.reshape(BSIZE, H_shape, W_shape,
...
def vit_base_patch16(**kwargs):
    model = GroupChannelsVisionTransformer(out_indices=[3,5,7,11], channel_embed=256, embed_dim=768, depth=12,
...
def vit_large_patch16(**kwargs):
    model = GroupChannelsVisionTransformer(out_indices=[9,11,15,23], channel_embed=256, embed_dim=1024, depth=24,
