...
class Resics45Dataset():
    ...
    def create_dataset(self):
        ...
        dataset_train = RESISC45(root=self.root_dir, split="train", transforms=train_transform)
        dataset_val = RESISC45(root=self.root_dir, split="val", transforms=eval_transform)
        dataset_test = RESISC45(root=self.root_dir, split="test", transforms=eval_transform)
