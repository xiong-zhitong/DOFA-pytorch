...
class GeoBench_so2sat_Config(GeoBenchDatasetConfig):
    ...
    band_names: List[str] = [
        '02 - Blue', '02 - Blue', '03 - Green', '04 - Red',
...
class GeoBench_cashew_Config(GeoBenchDatasetConfig):
    ...
    task: str = "segmentation"
    band_names: List[str] = [
        '04 - Red', '03 - Green', '02 - Blue', '05 - Vegetation Red Edge',
...
class GeoBench_SAcrop_Config(GeoBenchDatasetConfig):
    ...
    band_names: List[str] = [
        ...
        '05 - Vegetation Red Edge', '06 - Vegetation Red Edge', '07 - Vegetation Red Edge',
        '08 - NIR', '08A - Vegetation Red Edge', '09 - Water vapour', '11 - SWIR',
        '11 - SWIR', '12 - SWIR'
    ]
    band_wavelengths: List[float] = [
        0.44, 0.49, 0.56, 0.66, 0.7, 0.74, 0.78, 0.84, 0.86, 0.94, 1.37, 1.61, 2.2
    ]
    num_classes: int = 10
    multilabel: bool = False
    num_channels: int = len(band_names)
...
class Panopticon_seg_Config(BaseModelConfig):
    ...
    pretrained_path: str = "/home/zhitong/OFALL/OFALL_baseline/mae/DOFA-pytorch/fm_weights/panopticon-v1-1103"
    image_resolution: int = 224
    out_features: bool = True
    task: str = 'segmentation'
    freeze_backbone: bool = True
...
class Panopticon_cls_Config(BaseModelConfig):
    ...
    freeze_backbone: bool = True
    embed_dim: int = 768
    ds_name: str = "m-pv4ger"
    full_spectra: bool = False

class CROMA_cls_Config(BaseModelConfig):
    model_type: str = "croma"
    pretrained_path: str = "/home/zhitong/OFALL/OFALL_baseline/mae/DOFA-pytorch/fm_weights/CROMA_base.pt"
    size: str = 'base'
...
class ScaleMAE_seg_Config(BaseModelConfig):
    ...
    pretrained_path: str = "/home/zhitong/OFALL/OFALL_baseline/mae/DOFA-pytorch/fm_weights/scalemae-vitlarge-800.pth"
    image_resolution: int = 224
    out_features: bool = True
    freeze_backbone: bool = True
    task: str = 'segmentation'
...
class DOFA_seg_Config(BaseModelConfig):
    model_type: str = "dofa"
    pretrained_path: str = "/home/zhitong/OFALL/OFALL_baseline/mae/DOFA-pytorch/fm_weights/DOFA_ViT_large_e100.pth"
    image_resolution: int = 224
    out_features: bool = True
    freeze_backbone: bool = True
    task: str = 'segmentation'
...
class GFM_seg_Config(BaseModelConfig):
    model_type: str = "gfm"
    pretrained_path: str = "/home/zhitong/OFALL/OFALL_baseline/mae/eval-fm/fm_weights/gfm.pth"
